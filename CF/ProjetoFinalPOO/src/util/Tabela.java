...
public class Tabela {
    ...
    public JTable criarTabela(JPanel jpn, Object[] largura, Object[] pos, Object[] col) throws NullPointerException {
        ...
        for (int i = 0; i < largura.length; i++) {
            ...
            if (pos[i].equals("centro")) pos[i] = centro;
            if (pos[i].equals("direita")) pos[i] = direita;
            if (pos[i].equals("esquerda")) pos[i] = esquerda;
            
            tabela.getColumnModel().getColumn(i).setPreferredWidth(
